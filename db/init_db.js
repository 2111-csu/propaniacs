  ...
  try {
    const productsToCreate = [
      ...
      },
      {
        name: "Weber 3000",
        description:
          "A mighty fine starter grill. The 4 burners are great for meats, veggies, or anything else you'd like to grill",
        price: 550,
        imageURL:
      ...
      },
      {
        name: "Tongs",
        description:
          "Strong enough to lift the heaviest items, these tongs are a must for any grill master",
        price: 4.05,
        imageURL:
      ...
      },
      {
        name: "Spatula",
        description:
          "Equipped with a long, ergonomic handle, this stainless steel spatula is a joy to use.",
        price: 7.99,
        imageURL:
      ...
      },
      {
        ...
        description:
          "7'10' long & 30 inches in diameter, this tank is ideal to heat water heaters, generators, & pool heaters",
        price: 999.49,
        imageURL:
      ...
      },
      {
        ...
        description:
          "The ultimate experience in grilling. This 10 burner grill will crown you king of the block party!",
        price: 875.0,
        imageURL:
      ...
      },
      {
        name: "Grill Brush",
        description:
          "Durable steel bristles like these make cleaning the grill grates a breeze!",
        price: 10.25,
        imageURL:
      ...
      },
      {
        name: "3 Gallon Tank",
        description:
          "This tank is reinforced for travel purposes. It is a MUST for a convenient weekend getaway.",
        price: 14.99,
        imageURL:
      ...
      },
      {
        ...
        description:
          "If you're as excited by propane as we are, this apron will prove it!",
        price: 22.55,
        imageURL:
      ...
      },
      {
        name: "BBQ Fork",
        description:
          "A tool you don't realize you need until you do; buy it now & you won't regret it!",
        price: 9.95,
        imageURL:
      ...
      },
      {
        name: "Grill-N-Go",
        description:
          "A must for grillers who travel; this grill is perfect for camping, tailgating, & more!",
        price: 150.15,
        imageURL:
      ...
      },
      {
        ...
        description:
          "Ever wondered if something is medium-rare or medium? This thermometer can make that decision easier to manage.",
        price: 88.95,
      ...
      },
      {
        name: "Grill Skewers",
        description:
          "When wooden skewers won't do, look to these reliable stainless skewers.",
        price: 4.49,
        imageURL:
      ...
      },
      {
        name: "BBQ Mop",
        description:
          "Any BBQ enthusiast will stand by the mop as the ideal BBQ applicator.",
        price: 11.11,
        imageURL:
      ...
      },
      {
        ...
        description:
          "Just over 16 feet long & 41 inches in diameter, this is the tank you need for large square footage homes & when multiple appliances run on propane.",
        price: 2200,
        imageURL:
      ...
      },
      {
        name: "VW9 Smoker",
        description:
          "Not only does this smoker run off propane, but it also has a convenient window to check on its contents!",
        price: 1210.15,
        imageURL:
      ...
      },
      {
        name: "BBQ Gloves",
        description:
          "Insulated, waterproof, heat/oil resistant. What more could you ask for from these fine gloves?",
        price: 32.35,
        imageURL:
      ...
      },
      {
        name: "Grill Cleaner",
        description:
          "Our patented solution; this cleaner will have your grill looking as good as new!",
        price: 7.95,
        imageURL:
    ...
    const usersToCreate = [
      ...
      },
      {
        ...
        email: "1youdontneedtoknow@dalesdeadbug.com",
        username: "SmokingBandit1",
        password: "Manitoba1",
        isAdmin: false,
      },
      {
        firstName: "Rusty2",
        lastName: "Shackleford2",
        email: "2youdontneedtoknow@dalesdeadbug.com",
      ...
      {
        firstName: "Rusty3",
        lastName: "Shackleford3",
        email: "3youdontneedtoknow@dalesdeadbug.com",
      ...
      {
        firstName: "Rusty4",
        lastName: "Shackleford4",
        email: "4youdontneedtoknow@dalesdeadbug.com",
      ...
      {
        firstName: "Rusty5",
        lastName: "Shackleford5",
        email: "5youdontneedtoknow@dalesdeadbug.com",
